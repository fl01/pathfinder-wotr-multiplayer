...
namespace WOTRMultiplayer.Entities
{
    public class NetworkGame
    {
        ...
        public HashSet<long> PlayersInSettlement { get; set; } = [];
        ...
        public HashSet<long> PlayersInGlobalMapRecruitment { get; set; } = [];

        public HashSet<long> PlayersInGlobalMapEncounterMessage { get; set; } = [];

        public HashSet<long> PlayersInGlobalMapCrusadeArmyLeaderLeveling { get; set; } = [];
