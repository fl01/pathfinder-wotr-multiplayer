...
namespace WOTRMultiplayer.Config.Mapping
{
    public class NetworkMessagesProfile : Profile
    {
        public NetworkMessagesProfile()
        {
            ...
            CreateMap<NetworkUnitBuffCollection, Networking.Messages.Contracts.NetworkUnitBuffCollection>()
                .ReverseMap();

            CreateMap<NetworkUnitNegativeLevelsData, Networking.Messages.Contracts.NetworkUnitNegativeLevelsData>()
                .ReverseMap();
            ...
            CreateMap<NetworkCharacterStats, Networking.Messages.Contracts.NetworkCharacterStats>()
                .ReverseMap();
            ...
            CreateMap<NetworkKingdomSettlementBuilding, Networking.Messages.Contracts.NetworkKingdomSettlementBuilding>()
                .ReverseMap();
